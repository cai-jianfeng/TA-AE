...
def get_vector(model, processor, questions, output_file_name, use_tcd=False, frame_drop_type="all", ratio=1, nframes=16):
    ...
    for line in tqdm(questions):
        ...
        with torch.no_grad():
            inputs = get_inputs(processor, video_file, qs, gt_answer, resized_height=224, resized_width=224, nframes=nframes, ratio=ratio, frame_drop_type=frame_drop_type)
