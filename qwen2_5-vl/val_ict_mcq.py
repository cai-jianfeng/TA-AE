...
from qwen_utils import get_inputs
...
def main(): 
    ...
    parser.add_argument('--all', action='store_true', help='use all mcq data')
    parser.add_argument('--nframes', type=int, default=16, help='the default frame nums')
    ...
    if not os.path.exists(acc_file):
        ...
        acc_num_file = f'{args.result_folder}/accuracies_{args.video_type}_{args.sample_strategy}_{args.ratio}.txt'
    ...
    for line in tqdm(questions):
        ...
        with TraceDict(model, layers_to_intervene, edit_output=intervene) as ret:
            inputs = get_inputs(processor, video_file, qs, None, resized_height=224, resized_width=224, nframes=args.nframes, ratio=args.ratio, frame_drop_type="all")
