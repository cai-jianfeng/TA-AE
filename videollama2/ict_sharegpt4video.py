...
model, processor, tokenizer = model_init(model_path=model_path)

# get based vector
get_vector(model, processor, tokenizer, questions, output_file_name, use_tcd=False, frame_drop_type="all")
...
get_vector(model, processor, tokenizer, questions, output_file_name, use_tcd=True, frame_drop_type="interval", ratio=ratio)
